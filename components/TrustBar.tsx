...
export default function TrustBar() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 z-[15] flex items-center ps-5 sm:ps-8 rtl:left-auto rtl:right-0 rtl:pe-5 rtl:ps-0 rtl:sm:pe-8">
